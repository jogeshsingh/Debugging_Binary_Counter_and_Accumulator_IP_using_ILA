...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_35T/Axi_stream_debug_ILA/Axi_stream_debug_ILA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_DEBUG_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ILA_DEBUG_wrapper.tcl -notrace
