...
HD_PWD='E:/VIVADO_2022/ARTIX_A7_35T/Axi_stream_debug_ILA/Axi_stream_debug_ILA.runs/ILA_DEBUG_register_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_DEBUG_register_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_DEBUG_register_0_0.tcl
